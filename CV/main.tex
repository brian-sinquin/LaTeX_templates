...
\tagline{Doctorant en physique des LASERs / Ph.D Student in Photonics\\
  ...
  \cvtaglinequote{Oscillateur optoélectronique à modulation directe. Génération de signaux micro-ondes et d'impulsions optiques courtes}
}
\photo{2.8cm}{ID}
\personalinfo{%
...
\textit{Mention bien (Moy. 15.75/20 Rang 1/4)}
...
\textit{Mention assez bien (Moy. 13.446/20 Rang 1/11)}
\begin{cvlistdescription}
...
\textit{Mention très bien en L3 (Moy. 16/20 Rang 1/20 )}
\begin{cvlistdescription}
...
\cvjobtitle{Centre Régional des Œuvres Universitaires et Scolaires}
\begin{cvlistdescription}
    \item Accueil
...
\begin{fullwidth}
  ...
  % \printbibliography
  % \endgroup
  \cvsection{Diffusion scientifique (Oraux/Posters)}
  ...
  \cvevent{Journée du Club Optique Micro-ondes 2021}{Société Française d'Optique}{4 juin 2021}{France}
  \cveventtitle{Signaux Opto-RF très bas bruit de phase et instabilités dynamiques d’un OEO à modulation directe}
  \cveventlink{https://hal.archives-ouvertes.fr/FOTON-DOP/hal-03285993}{Présentation orale de 15 minutes en visio-conférence (COVID)}

  \divider

  \cvevent{CLEO\textregistered/Europe-EQEC 2021}{Conference on Lasers and Electro-Optics}{21--25 juin 2021}{Munich -- Allemagne}
  \cveventtitle{Low phase noise microwave generation from a direct-modulation optoelectronic oscillator (DM-OEO)}
  ...
  \cveventlink{https://hal.archives-ouvertes.fr/FOTON-DOP/hal-03284744}{Présentation de poster lors de l'événement}
...
\cveventlink{https://hal.science/hal-03988116}{Présentation orale de 15 minutes}
  ...
  \cvevent{Journée du Club Optique Micro-ondes 2023}{Société Française d'Optique}{19 juin 2023}{France}
...
\cveventtitle{Direct-Modulation Optoelectronic Oscillator for Optical Frequency Comb and Pulse Generation}
\cveventlink{https://doi.org/10.1109/CLEO/Europe-EQEC57999.2023.10231990}{Présentation orale de 15 minutes}

  \divider

  \cvevent{CLEO\textregistered/Europe-EQEC 2023}{Conference on Lasers and Electro-Optics}{26--30 juin 2023}{Munich -- Allemagne}
  \cveventtitle{Accurate Measurement of the Linewidth Enhancement Factor of Semiconductor Lasers by a Simple Technique }
