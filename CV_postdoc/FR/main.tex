...
\textbf{Interférométrie à double peignes de fréquence à fort taux de répétition dans le proche infrarouge pour application à la métrologie dimensionnelle}\smallskip
...
\medskip
  ...
  \begin{itemize}
    ...
    \medskip
    \item \normalsize \fullcite{Sinquin2024}
    \medskip
    \item \normalsize \fullcite{Sinquin2025b}
  \end{itemize}
...
{\quote{Oscillateur opto-électronique intégrant une cavité ULE asservie par `` tilt-locking ''}}

\medskip

{Présentation orale par Pr. Marc Vallet} | \href{https://hal.science/hal-05120292v1}{hal-05120292v1}
...
{Présentation orale de 15 minutes en visio-conférence (COVID)} | {\color{red}\faYoutubePlay}  \href{https://www.youtube.com/watch?v=NiCSm7F7ba8}{https://www.youtube.com/watch?v=NiCSm7F7ba8}
...
\vspace{-0.5em}\textbf{Encadrement des étudiants de Licence 2 en Physique pour une initiation au travail de groupe en mode projet dans l'objectif de mesurer et expérimenter la physique avec des moyens rudimentaires}
...
\vspace{-0.5em}\textbf{Nouvelle architecture d'interférométrie à double peignes de fréquence pour l'imagerie hyper-spectrale}
